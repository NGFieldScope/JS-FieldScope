<%@ WebHandler Language="C#" Class="MetaLensProxyService" %>
...
public class MetaLensProxyService : IHttpHandler {

  static readonly TimeSpan CACHE_DURATION = TimeSpan.FromMinutes(30);
  
  public void ProcessRequest (HttpContext context) {
    
    string server = HttpUtility.UrlDecode(context.Request.QueryString["server"]);
    string assetId = HttpUtility.UrlDecode(context.Request.QueryString["asset"]);
    string url = server + "/assets/" + assetId + "/proxy/hires.cpx";
