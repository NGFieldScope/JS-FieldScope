...
public class ArcGISLegendService : IHttpHandler {
  ...
  public void ProcessRequest (HttpContext context) {
    ...
    if (context.Cache[requestUri] != null) {
      ...
      byte[] data = { };
      if (format.Equals("json", System.StringComparison.OrdinalIgnoreCase)) {
        context.Response.ContentType = "application/json";
        data = System.Text.Encoding.ASCII.GetBytes(ArcGIS.MapService.GetLegendJson(serviceUri).ToString());
      } else {
