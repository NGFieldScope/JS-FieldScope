...
// Increase the maxConcurrentCall if you require more servcies to be called async, IE default is only 2
...
QueuedCall.prototype = {
  execute : function() {
    Sys.Net.WebServiceProxy.originalinvoke(this.servicePath, 
                                            this.methodName, 
                                            this.useGet, 
                                            this.params,  
...
//override invoke
Sys.Net.WebServiceProxy.originalinvoke = Sys.Net.WebServiceProxy.invoke;
